...
**Slide Deck**: Python Basics
**HW assignment**: Complete the Day 1 Homework first (links above)
...
Basic Statistics
Common Plots
**HW Solutions**: Python ### Day 7 HW solutions (Tic Tac Toe)
**Video Lecture**: _Lecture Link_
---------------------------------------------------------
